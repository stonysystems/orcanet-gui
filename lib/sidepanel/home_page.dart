...
class HomePage extends StatelessWidget {
  ...
  Future<List<FlSpot>> _fetchUploadSpeedData() async {
    ...
    return List.generate(
      ...
      (index) {
        double fluctuation =
            (random.nextDouble() * fluctuationRange * 2) - fluctuationRange;
        double speed = (baseUploadSpeed + fluctuation)
            .clamp(0, double.infinity); // Avoid negative speeds
  ...
  Future<List<FlSpot>> _fetchDownloadSpeedData() async {
    ...
    return List.generate(
      ...
      (index) {
        double fluctuation =
            (random.nextDouble() * fluctuationRange * 2) - fluctuationRange;
        double speed = (baseDownloadSpeed + fluctuation)
            .clamp(0, double.infinity); // Avoid negative speeds
        return FlSpot(index.toDouble(), speed);
      },
    );
